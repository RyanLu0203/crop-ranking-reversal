...
ranking boundary, or bound all optima on the objective-equivalent face.
...
portfolio. Our criterion therefore requires a conventional policy to pass a
fixed variance benchmark yet fail under the Student-\(t\) evaluation law and
differ from the tail-aware allocation.
