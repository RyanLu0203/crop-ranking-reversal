...
CVaR budget. Nested action sets raise both
...
These results repair an unconditional supermodularity claim. For the complete
shared-ex-ante-CVaR numerical programme we instead compute, on every adjacent
grid rectangle,
\[
\Delta_{q,\phi}V=
...
classifications, not an extension of the restricted theorem.
