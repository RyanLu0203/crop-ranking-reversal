...
GOAL-11 and GOAL-14 were approved at their supervisor checkpoints. GOAL-12 is a versioned confirmatory package under `simulation/stage_ii/`: it preserves all prospective precision failures, registered infeasibilities, counterexample boundaries and simulation-only evidence labels. Completion of GOAL-12 authorizes only a supervisor handoff and stop; GOAL-13 remains locked pending explicit approval.
