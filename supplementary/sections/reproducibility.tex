...
\paragraph{Artifact availability.} The main source is \path{manuscript/main.tex}; this supplement is \path{supplementary/supplementary.tex}. Figure and table registries provide generating commands, source data, configurations and checksums. The cover page retains explicit placeholders only for author-owned metadata and declarations that cannot be inferred from scientific evidence.
