...
than every lower-ranked crop. Following the supervisor Draft, strong reversal
is narrower: a higher-ranked crop is excluded, \(x_i=0<x_j\), while a
...
reversal and \PhaseStrong{} show true strong exclusion reversal. Two cells contain multiple
optima, no cells are infeasible, and one Clayton path is disconnected on the
registered grid. Selected pairwise reversal occurs in
