...
\caption{\textbf{Resampling quantifies short-record sensitivity, not
farm-level prevalence.} \textbf{a}, Top-rank disagreement rates and
state-cluster bootstrap distributions in \StateYears{} state-years. Half
densities use all 5,000 draws, dots show a fixed 72-draw display subset, thick
...
interval. \textbf{c}, Leakage-free lagged association between prior score
