...
state-cluster 95\% intervals in \StateYears{} state-years. \textbf{b},
...
interval. \textbf{c}, Continuous allocation distributions across the same
registered resamples; their summaries use genuine percentile intervals.}
\label{fig:external}
\end{figure}
