...
The Kansas experiment shows the cost of treating the selected Gaussian
mean--variance policy as tail safe. Under matched rank dependence, that policy earns a
higher mean but violates the Student-\(t\) evaluation-law loss-CVaR ceiling. This
suggests a governance test for decision-support systems: report the allocation
under at least one
